(function () {
  ...
  const SUNBURST_NODES = [
    { id: 'root', parent: null, label: 'SYOP Averages', subtitle: 'SYOP [ႽP] • BRKO [BO]', value: 51.6 },
    
    { id: 'qb', parent: 'root', label: 'QB', subtitle: 'Quarterbacks', value: 16.46, series: 'QB' },
    { id: 'qb-prime-lambda', parent: 'qb', label: 'Prime Λ', subtitle: '7.2 yrs', value: 6.3, abbr: 'ꜱᴘᴧ', stat: '7.2' },
    { id: 'qb-prime-mode', parent: 'qb', label: 'Prime M', subtitle: '6.0 yrs', value: 5.15, abbr: 'ꜱᴘϻ', stat: '6.0' },
    { id: 'qb-breakout-lambda', parent: 'qb', label: 'Breakout Λ', subtitle: '2.3 yrs', value: 2.69, abbr: 'ʙᴏᴧ', stat: '2.3' },
    { id: 'qb-baseline-mode', parent: 'qb', label: 'Baseline M', subtitle: '1.0 yrs', value: 2.3, abbr: 'ʙᴏϻ', stat: '1.0' },
    ...
    { id: 'wr-prime-lambda', parent: 'wr', label: 'Prime Λ', subtitle: '4.9 yrs', value: 4.62, abbr: 'ꜱᴘᴧ', stat: '4.9' },
    { id: 'wr-prime-mode', parent: 'wr', label: 'Prime M', subtitle: '3.0 yrs', value: 2.9, abbr: 'ꜱᴘϻ', stat: '3.0' },
    { id: 'wr-breakout-lambda', parent: 'wr', label: 'Breakout Λ', subtitle: '2.9 yrs', value: 2.84, abbr: 'ʙᴏᴧ', stat: '2.9' },
    { id: 'wr-baseline-mode', parent: 'wr', label: 'Baseline M', subtitle: '2.0 yrs', value: 2.4, abbr: 'ʙᴏϻ', stat: '2.0' },
    
    { id: 'te', parent: 'root', label: 'TE', subtitle: 'Tight Ends', value: 12.5, series: 'TE' },
   
    { id: 'te-prime-lambda', parent: 'te', label: 'Prime Λ', subtitle: '4.0 yrs', value: 3.71, abbr: 'ꜱᴘᴧ', stat: '4.0' },
    { id: 'te-prime-mode', parent: 'te', label: 'Prime M', subtitle: '2.0 yrs', value: 2.5, abbr: 'ꜱᴘϻ', stat: '2.0' },
    { id: 'te-breakout-lambda', parent: 'te', label: 'Breakout Λ', subtitle: '3.5 yrs', value: 3.29, abbr: 'ʙᴏᴧ', stat: '3.5' },

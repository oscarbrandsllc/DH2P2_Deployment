...
(function () {
  ...
  const TICK_MS = 50;                           // render heartbeat
  const LOCK_MS = 260;                          // speed each next letter locks
  const SCRAMBLE_MIN_MS = 200;                  // dud char holds longer -> slower-looking flicker
  const SCRAMBLE_MAX_MS = 320;
